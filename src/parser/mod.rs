use crate::parser::comment::{comment_parser, CommentType};
use crate::parser::common::empty_line_parser;
use crate::parser::samples::{parse_sample, SampleEntry};
use crate::parser::types::{Err, Metric, MetricType, Sample};
use nom::branch::alt;
